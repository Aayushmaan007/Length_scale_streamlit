...
def _get_color_for_correlation(correlation_value):
    ...
    if correlation_value >= 0.7:
        ...
        return 'limegreen' # Changed for better visibility
    elif correlation_value > -0.4:
        return 'gray'
    elif correlation_value > -0.7:
        return 'salmon' # Changed for better visibility
    else:
        return 'darkred'
...
def create_correlation_map(base_station_id, correlation_matrix, coordinates, save_path=None):
    ...
    Args:
        base_station_id (str): The ID of the station to use as the reference.
        correlation_matrix (pd.DataFrame): The Spearman correlation matrix.
        coordinates (dict): A dictionary with station IDs as keys and their 
                            lat/lon as values.
        save_path (str, optional): The file path to save the PNG map. 
                                   Defaults to None.
    """
